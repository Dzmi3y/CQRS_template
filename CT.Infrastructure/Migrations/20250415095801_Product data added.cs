        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("08f35a7b-f8e8-48f3-8596-60e157c072a3"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5282), "images/macarons/set2.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5282), "Macaron set #2", 10.00m, "Set" },
                    { new Guid("0ea0c77b-5389-418c-bc39-aa53c7faf1d0"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5295), "images/macarons/set6.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5296), "Macaron set #6", 10.00m, "Set" },
                    ...
                    { new Guid("3e12e305-73fb-4476-a9a7-d70d7a8d1798"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5291), "images/macarons/set4.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5291), "Macaron set #4", 10.00m, "Set" },
                    ...
                    { new Guid("9cc9b4f4-c5a6-4c05-b471-336bd8b96794"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5280), "images/macarons/set1.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5280), "Macaron set #1", 10.00m, "Set" },
                    ...
                    { new Guid("e00af05d-272a-4c9e-9383-c6b1853e4e3d"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5293), "images/macarons/set5.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5294), "Macaron set #5", 10.00m, "Set" },
                    { new Guid("f2361fd0-134d-4a7c-b4a5-e7948e19c0d0"), null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5289), "images/macarons/set3.png", false, null, new DateTime(2025, 4, 15, 9, 43, 28, 725, DateTimeKind.Utc).AddTicks(5289), "Macaron set #3", 10.00m, "Set" },
