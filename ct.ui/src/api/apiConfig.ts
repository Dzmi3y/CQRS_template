...
export const BASE_URL = "http://localhost:5085";
export const BASE_URL_API = `${BASE_URL}/api`;
export const LOGIN_URL_API = `${BASE_URL_API}/auth/login`;
export const INFO_URL_API = `${BASE_URL_API}/auth/info`;
export const REFRESH_TOKEN_API = `${BASE_URL_API}/auth/refresh`;
